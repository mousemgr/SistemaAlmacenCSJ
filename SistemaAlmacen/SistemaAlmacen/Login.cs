...
namespace SistemaAlmacen
{
    public partial class login : Form
    {
        ...
        private void entrar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                SqlConnection con = new SqlConnection(@"Data Source=WIN-SERVER\JAGUARIRA;Initial Catalog=SistemaAlmacen;Persist Security Info=True;User ID=sa;Password=Jaguar1");
